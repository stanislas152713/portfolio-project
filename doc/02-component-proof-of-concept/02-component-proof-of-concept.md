...
My choice: `storyGenerator`. Reasons are listed below:
- **Enthusiasm against inertia**: I love writing and want to combine that with my major, which will decrease the chance of the "Why do I give valuable time to such boring stuff" scenario happening. Isn't it exciting to see *creative* ideas generated by *machines*?
- **Feasibility**: I expect it to be not too difficult to create a storyGenerator with preset categories and order.
- **Extensibility**: If I want to add more features (e.g., customized categories and order), I can build on this simple version.
